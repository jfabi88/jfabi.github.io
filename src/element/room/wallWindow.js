...
export function createWallWindows() {             //deprecated
  ...
  var w1 = createWindowOptimized(25, 50, 2, 1.5);
  var w2 = createWindowOptimized(25, 50, 2, 1.5);
  var w3 = createWindowOptimized(25, 50, 2, 1.5);
  var w4 = createWindowOptimized(25, 50, 2, 1.5);

  w1.position.set(45, 5, 1);
  w2.position.set(15, 5, 1);
  w3.position.set(-15, 5, 1);
  w4.position.set(-45, 5, 1);
